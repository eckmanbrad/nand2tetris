...
STATIC, FIELD, ARGUMENT, LOCAL = "STATIC", "FIELD", "ARG", "VAR"
TYPE, KIND, INDEX = range(3)
...
class SymbolTable:
    ...
    def __init__(self) -> None:
        ...
        self.kind_count = {STATIC: 0, FIELD: 0, LOCAL: 0, ARGUMENT: 0}
    ...
    def define(self, name: str, type: str, kind: str) -> None:
        ...
        """
        symbol_data = (type, kind, self.kind_count[kind])
        if kind == STATIC or kind == FIELD:
            self.class_table[name] = symbol_data
        if kind == ARGUMENT or kind == LOCAL:
